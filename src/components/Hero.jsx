    ...
    <section className={`relative w-full h-screen mx-auto overflow-hidden`}>
      ...
      <div className={`absolute inset-0 sm:top-[120px] top-[30px] max-w-7xl mx-auto ${styles.paddingX} flex flex-row items-start pointer-events-none`}>
        ...
        <div className="flex-1 flex flex-col lg:justify-center justify-start z-10 pointer-events-auto h-full">
          ...
          <h1 className="font-black text-white lg:text-[52px] sm:text-[40px] xs:text-[30px] text-[26px] leading-tight">
            AI AUTOMATION & WEB
          ...
          <p className="mt-2 text-secondary font-mono tracking-widest text-[16px] lg:text-[18px] mb-6 uppercase">
            GOHIGHLEVEL • AI AUTOMATION • WEB DEVELOPMENT
          </p>
          ...
          <div className="flex flex-wrap gap-4 mt-1">
            <a
              href="https://calendly.com/culabaraphael"
              target="_blank"
              rel="noopener noreferrer"
              className="bg-[#915EFF] hover:bg-[#804dee] text-white py-3 px-6 rounded shadow-[0_4px_14px_0_rgba(145,94,255,0.39)] transition-all font-bold tracking-wide flex items-center gap-2 text-[14px]"
            >
      ...
      {/* 3D Model Container - with Drag Hint */}
