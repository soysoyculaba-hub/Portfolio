...
const services = [
  ...
  },
  {
    ...
    description: "Setting up GoHighLevel systems with automated follow-ups, lead tracking, and reporting dashboards that increase lead capture.",
    icon: crm,
  },
  {
...
const experiences = [
  ...
  },
  {
    ...
    company_name: "Austen Accent Law / RapidRegisteredAgent.com",
    icon: austin_accident_lawyer,
    iconBg: "#ffffff",
    date: "Feb 2026",
    points: [
...
const portfolioProjects = [
    ...
    projects: [
      {
        ...
        label: "Retell AI · n8n Automation",
        description: "Fully automated front-desk voice agent built on Retell AI for a US-based personal injury law firm. Sofia answers inbound calls 24/7, greets callers, qualifies intent, and intelligently routes them — transferring to a live attorney or handing off to the intake agent. Integrated with n8n for real-time call flow logic and fallback handling.",
        tags: [
          { name: "retell-ai", color: "orange-text-gradient" },
          { name: "n8n", color: "pink-text-gradient" },
          { name: "voice-agent", color: "blue-text-gradient" },
          { name: "call-routing", color: "green-text-gradient" },
          { name: "ai", color: "pink-text-gradient" },
        ],
        image: sofia_receptionist,
        source_code_link: "#",
      },
      {
        title: "AI Legal Intake Voice Agent",
        label: "Retell AI · n8n Automation",
        description: "Conversational AI intake agent that conducts structured legal consultations over the phone. Julia collects case details, injury information, and contact data from potential clients, then triggers an n8n workflow that formats and emails a full intake summary to the legal team and sends a BoldSign e-signature agreement automatically.",
        tags: [
          { name: "retell-ai", color: "orange-text-gradient" },
          { name: "n8n", color: "pink-text-gradient" },
          { name: "boldsign", color: "blue-text-gradient" },
          { name: "intake", color: "green-text-gradient" },
          { name: "legal-automation", color: "pink-text-gradient" },
        ],
        image: julia_intake,
        source_code_link: "#",
      },
      {
        title: "AI Sales & Appointment-Booking Voice Agent",
        label: "Retell AI · n8n Automation",
        description: "Outbound-ready AI sales agent designed to follow up with leads, pitch legal services, and book consultations directly into the attorney's calendar. Integrated with Microsoft Outlook Calendar via n8n for live availability checks and automated confirmation emails, reducing manual follow-up time to zero.",
        tags: [
          { name: "retell-ai", color: "orange-text-gradient" },
          { name: "n8n", color: "pink-text-gradient" },
          { name: "outlook", color: "blue-text-gradient" },
          { name: "appointment-booking", color: "green-text-gradient" },
          { name: "sales-automation", color: "pink-text-gradient" },
        ],
        image: sales_agent,
        source_code_link: "#",
      },
  ...
  },
  {
    ...
    projects: [
      ...
      {
        title: "Sofia – Check Calendar Availability",
        label: "n8n Automation · Retell AI",
        description: "Webhook-triggered workflow that queries the attorney's Microsoft Outlook 365 calendar in real time, calculates available appointment slots, and returns the results back to the Sofia AI voice agent so callers get accurate availability during the call.",
        tags: [
          { name: "n8n", color: "pink-text-gradient" },
          { name: "retell-ai", color: "orange-text-gradient" },
          { name: "outlook-365", color: "blue-text-gradient" },
          { name: "webhook", color: "green-text-gradient" },
          { name: "voice-ai", color: "pink-text-gradient" },
        ],
        image: sofia_check_calendar,
        source_code_link: "#",
      },
      {
        title: "Sofia – Book Appointment",
        label: "n8n Automation · Retell AI",
        description: "Webhook-triggered workflow that creates a new calendar event in Microsoft Outlook 365, sends a confirmation email to the client, formats the booking response, and returns a confirmation back to the Sofia AI agent — all within the same live call.",
        tags: [
          { name: "n8n", color: "pink-text-gradient" },
          { name: "retell-ai", color: "orange-text-gradient" },
          { name: "outlook-365", color: "blue-text-gradient" },
        ...
        image: sofia_book_appointment,
        source_code_link: "#",
      },
      {
        title: "Sofia – Cancel Appointment",
        label: "n8n Automation · Retell AI",
        description: "Searches the attorney's Outlook 365 calendar for a matching event based on caller input, uses conditional logic to handle both found and not-found cases, deletes the event if located, and sends a cancellation confirmation back to the Sofia AI agent with the appropriate response.",
        tags: [
          { name: "n8n", color: "pink-text-gradient" },
          { name: "retell-ai", color: "orange-text-gradient" },
          { name: "outlook-365", color: "blue-text-gradient" },
          { name: "conditional-logic", color: "green-text-gradient" },
          { name: "webhook", color: "orange-text-gradient" },
        ],
        image: sofia_cancel_appointment,
        source_code_link: "#",
      },
      {
        title: "Sofia – Send Message Email",
        label: "n8n Automation · Retell AI",
        description: "Simple but essential workflow that captures a caller's message via webhook from the Sofia AI agent and immediately emails it to the attorney through Microsoft Outlook 365 — ensuring no message goes unread even when the attorney is unavailable.",
        tags: [
          { name: "n8n", color: "pink-text-gradient" },
          { name: "retell-ai", color: "orange-text-gradient" },
          { name: "outlook-365", color: "blue-text-gradient" },
        ...
        image: sofia_send_message,
        source_code_link: "#",
      },
      {
        title: "Sofia – Day Before Appointment Reminder",
        label: "n8n Automation · Retell AI",
        description: "Scheduled workflow that runs daily, calculates tomorrow's date, pulls upcoming consultation events from Outlook 365, and uses conditional branching to send email reminders to clients who have an email on file, a different attorney-facing notification for those without one, and an SMS reminder via Twilio — with a clean exit path when no events exist.",
        tags: [
          { name: "n8n", color: "pink-text-gradient" },
          { name: "outlook-365", color: "blue-text-gradient" },
          { name: "sms", color: "orange-text-gradient" },
          { name: "scheduled-trigger", color: "green-text-gradient" },
          { name: "conditional-logic", color: "pink-text-gradient" },
        ],
        image: sofia_workflow,
        source_code_link: "#",
      },
      {
        title: "Julia AI Intake Agent – Email Automation",
        label: "n8n Automation · Retell AI",
        description: "Built the backend n8n workflow for Julia, an AI legal intake voice agent for a personal injury law firm. After Julia qualifies a caller's case and collects their information over the phone, the workflow triggers via webhook, formats a structured intake summary email, and delivers it instantly to the attorney through Microsoft Outlook — eliminating manual data entry from every intake call.",
        tags: [
          { name: "n8n", color: "pink-text-gradient" },
          { name: "retell-ai", color: "orange-text-gradient" },
          { name: "outlook-365", color: "blue-text-gradient" },
        ...
        image: julia_intake_workflow,
        source_code_link: "#",
      },
      {
        title: "Post-Call Recording & Transcript Email",
        label: "n8n Automation · Retell AI",
        description: "Built a global post-call webhook workflow that fires automatically after every Retell AI call ends. It formats call data — including the transcript, recording link, caller info, and sentiment — into a clean structured email and sends it to the attorney via Microsoft Outlook, giving the legal team a full call record without lifting a finger.",
        tags: [
          { name: "n8n", color: "pink-text-gradient" },
          { name: "retell-ai", color: "orange-text-gradient" },
          { name: "outlook-365", color: "blue-text-gradient" },
        ...
        image: retell_post_call_workflow,
        source_code_link: "#",
      },
      {
        title: "PDF Batch Summary Automation (1,500+ Files)",
        label: "n8n Automation · OpenAI · Google Drive",
        description: "Built a large-scale batch processing pipeline for Rapid Registered Agent that loops through 52 state-specific Google Drive folders, downloads each PDF, extracts the text, summarizes it via OpenAI, and aggregates all results into a CSV file that's uploaded back to Drive and emailed as a report. Successfully processed 1,500+ state registration forms in a single automated run.",
        tags: [
          { name: "n8n", color: "pink-text-gradient" },
          { name: "openai", color: "green-text-gradient" },
          { name: "google-drive", color: "blue-text-gradient" },
          { name: "batch-processing", color: "orange-text-gradient" },
          { name: "pdf-automation", color: "pink-text-gradient" },
          { name: "api-integration", color: "green-text-gradient" },
        ],
        image: pdf_batch_workflow,
        source_code_link: "#",
      },
      {
        title: "BoldSign Document Signing Automation",
        label: "n8n Automation · BoldSign API",
        description: "Built an n8n workflow for Austin Accident Lawyer that listens for form submissions and webhook events, then automatically fires an HTTP POST request to the BoldSign API to trigger document signing — removing the manual step of sending e-signature requests after every new client inquiry.",
        tags: [
          { name: "n8n", color: "pink-text-gradient" },
          { name: "boldsign", color: "blue-text-gradient" },
          { name: "webhook", color: "orange-text-gradient" },
          { name: "e-signature", color: "green-text-gradient" },
          { name: "api-integration", color: "pink-text-gradient" },
        ],
        image: boldsign_workflow,
        source_code_link: "#",
      },
    ],
  },
  {
    ...
    projects: [
      ...
      {
        title: "Seller SMS Drip Automation",
        label: "GoHighLevel Automation",
        description: "Automated SMS drip campaign for seller leads. Delivers timed follow-up messages to nurture motivated sellers, maintain engagement, and increase response rates throughout the sales pipeline.",
        tags: [
          { name: "gohighlevel", color: "orange-text-gradient" },
        ...
        image: seller_sms_drip,
        source_code_link: "https://drive.google.com/drive/folders/1wuLRb37DTwxaOVmEfsX1TnAHFkY1flu-?usp=sharing",
      },
      {
        title: "Buyer SMS Drip Automation",
        label: "GoHighLevel Automation",
        description: "Automated SMS drip campaign for buyer leads. Sends strategic follow-up messages to cash buyers, keeping them engaged and informed about new off-market property opportunities.",
        tags: [
          { name: "gohighlevel", color: "orange-text-gradient" },
          { name: "sms", color: "blue-text-gradient" },
          { name: "automation", color: "pink-text-gradient" },
        ...
        image: buyer_sms_drip,
        source_code_link: "https://drive.google.com/drive/folders/1wuLRb37DTwxaOVmEfsX1TnAHFkY1flu-?usp=sharing",
      },
      {
        title: "Seller Lead Automation",
        label: "GoHighLevel Automation",
        description: "Complete lead automation workflow for seller inquiries. Automatically captures, tags, and routes seller leads through the pipeline while triggering personalized follow-up sequences.",
        tags: [
          { name: "gohighlevel", color: "orange-text-gradient" },
          { name: "automation", color: "pink-text-gradient" },
          { name: "lead-management", color: "blue-text-gradient" },
          { name: "real-estate", color: "green-text-gradient" },
        ],
        image: seller_lead_automation,
        source_code_link: "https://drive.google.com/drive/folders/1wuLRb37DTwxaOVmEfsX1TnAHFkY1flu-?usp=sharing",
      },
      {
        title: "Buyer Lead Automation",
        label: "GoHighLevel Automation",
        description: "Complete lead automation workflow for buyer inquiries. Automatically processes cash buyer leads, assigns tags, creates opportunities, and initiates targeted nurture sequences.",
        tags: [
          { name: "gohighlevel", color: "orange-text-gradient" },
          { name: "automation", color: "pink-text-gradient" },
          { name: "lead-management", color: "blue-text-gradient" },
        ...
        image: buyer_lead_automation,
        source_code_link: "https://drive.google.com/drive/folders/1wuLRb37DTwxaOVmEfsX1TnAHFkY1flu-?usp=sharing",
      },
      {
        title: "Lead Disposition Workflow",
        label: "GoHighLevel Automation",
        description: "Automated lead disposition workflow that categorizes and routes leads based on their status. Streamlines lead management by automatically updating tags, pipeline stages, and triggering appropriate follow-up actions.",
        tags: [
          { name: "gohighlevel", color: "orange-text-gradient" },
          { name: "automation", color: "pink-text-gradient" },
          { name: "lead-management", color: "blue-text-gradient" },
